...
const EXPECTED_FS_BOUNDARIES = [
  ...
  ['backend/flight-recording/flight-csv-store.ts', 'recording-storage', 'existsSync=1'],
  ...
  ['backend/flight-recording/recording-bundle-status.ts', 'recording-storage', 'closeSync=6,existsSync=2,fstatSync=6,fsyncSync=2,linkSync=1,lstatSync=9,openSync=5,promises.lstat=2,promises.open=2,readSync=3,unlinkSync=1,writeSync=1'],
