...
const TEST_STEPS = [
  ...
  // Native mouse/touch input catches focus-dismissal races that DOM .click()
  // and keyboard-only component checks cannot reproduce. Builds run above.
  ['node', ['tests/scripts/test-app-workbench-browser.js']],
  ['node', ['tests/scripts/test-aircraft-layout-browser.js']],
  ['node', ['tests/scripts/test-timeline-load-recovery.js']],
  ['node', ['--test', 'frontend/src/cues/flight-cues-model.test.js', 'tests/scripts/test-flight-cues.js']],
  ['npm', ['run', 'test:voice']],
  ['node', ['tests/scripts/test-ptt-helper-parent-lifecycle.js']],
  ['node', ['tests/scripts/test-ptt-helper-joystick-modes.js']],
  ...
  ['node', ['--test', 'frontend/src/landing/share-image.test.js', 'frontend/src/app/screen-wake.test.js']],
  ...
  ['node', ['--test', 'dist/backend/aircraft/control-evidence.test.js']],
  ...
  ['node', ['--test', 'dist/backend/aircraft/com-radio.test.js']],
  ['node', ['--test', 'tests/scripts/test-com-radio.js']],
  ['node', ['--test', 'dist/backend/aircraft/baro.test.js']],
  ['node', ['--test', 'tests/scripts/test-baro-controls.js', 'tests/scripts/test-fenix-baro-controls.js']],
  ['node', ['--test', 'dist/backend/aircraft/a32nx-approach-controls.test.js']],
  ['node', ['--test', 'dist/backend/aircraft/a32nx-atc-efis.test.js', 'dist/backend/telemetry-provider/a32nx-minimums-control.test.js']],
  ['node', ['--test', 'frontend/src/voice/state-queries.test.js', 'tests/scripts/test-a32nx-atc-voice.js', 'tests/scripts/test-atc-aircraft-families.js']],
  ['node', ['--test', 'tests/scripts/test-a32nx-approach-voice.js', 'tests/scripts/test-approach-aircraft-families.js']],
