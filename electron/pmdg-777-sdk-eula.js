...
const PMDG_777_PACKAGE_DIRS = Object.freeze([
  'pmdg-aircraft-77w',
  'pmdg-aircraft-77l',
  'pmdg-aircraft-77er',
  'pmdg-aircraft-77f',
]);
const PMDG_777_SDK_EULA_RELATIVE_PATH = Object.freeze([
  'Documentation',
  'SDK',
  'PMDG_777_MSFS_SDK.pdf',
]);
...
function resolvePmdg777SdkEulaPath(installs, fsImpl = fs) {
  for (const communityFolder of uniqueCommunityFolders(installs)) {
    for (const packageDir of PMDG_777_PACKAGE_DIRS) {
      const candidate = path.join(
        communityFolder,
        packageDir,
        ...PMDG_777_SDK_EULA_RELATIVE_PATH,
      );
...
module.exports = {
  PMDG_777_PACKAGE_DIRS,
  PMDG_777_SDK_EULA_RELATIVE_PATH,
  resolvePmdg777SdkEulaPath,
};
