...
export declare const PRIVILEGED_CLIENT_MESSAGE_TYPES: readonly ["saveAppSettings", "fuelUnit", "showBranding", "flightPlan", "startRecording", "stopRecording", "endFlightManual", "requestTimeline", "requestTimelineList", "deleteFlightCsv", "setDestinationTarget", "clearDestinationTarget", "setOriginTarget", "clearOriginTarget", "exportProfile", "listProfiles", "requestLogbook", "requestHistoryIndexStatus", "checkHistoryIndex", "rebuildHistoryIndex", "lvarDebugWatch", "testShake"];
