...
export function mergeFdmData(frameFdm: FdmLike | null | undefined, sc: SimconnectLike): FdmLike {
  ...
  return {
    ...
    noseSteerPct: prefer(scFdm.noseSteerPct, fdm.noseSteerPct),
    brakeLeftPct: prefer(scFdm.brakeLeftPct, fdm.brakeLeftPct),
    brakeRightPct: prefer(scFdm.brakeRightPct, fdm.brakeRightPct),
...
export function buildVreEnrichedFrame({
  ...
  return {
    ...
    noseSteerPct: recordingFdm.noseSteerPct,
    brakeLeftPct: recordingFdm.brakeLeftPct,
    brakeRightPct: recordingFdm.brakeRightPct,
