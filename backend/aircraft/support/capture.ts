...
function createCapture({ report, fieldIds, aircraftVersion, simulatorVersion, condition, now = Date.now }: Record<string, any>) {
...
async function captureSession(options): Promise<ReturnType<ReturnType<typeof createCapture>['finish']>> {
...
export { createCapture, captureSession, validateEndpoint };
