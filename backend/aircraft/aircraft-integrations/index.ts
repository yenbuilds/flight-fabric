...
} = require('./inibuilds-a350') as {
  INIBUILDS_A350_1000_PROFILE_KEY: string;
  INIBUILDS_A350_900_PROFILE_KEY: string;
  INIBUILDS_A350_ADAPTER_ID: string;
  INIBUILDS_A350_INTEGRATION: AircraftIntegrationDefinition;
};
const {
