...
export const subscribeTakeoffReceived = (handler) => subscribeSignal('takeoffReceived', handler);
...
export const emitTakeoffReceived = (detail) => emitSignal('takeoffReceived', detail);
